...
for (let i = 0; i <  orderedUnionPay.length; i++) {
    ...
    console.log(`Highest paying job in 2018 with Union code ${currentUnion.unionCode} is ${currentUnion.title} with an biWeekly income of $${currentUnion.highest}.`);
}
...
console.log("How many new jobs in COMMN did we have each year? How many were lost?");
